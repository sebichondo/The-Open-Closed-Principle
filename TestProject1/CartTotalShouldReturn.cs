...
namespace CommerceProject
{
    ...
    public class CartTotalShouldReturn
    {
        ...
        [TestMethod]
        public void BlackFridayBuyoneGet1000Discount()
        {
            _cart.Add(new OrderItem() { Quantity = 1, Sku = "BF" });
            Assert.AreEqual(-999, _cart.TotalAmount());
        }

        [TestMethod]
        public void BlackFridaywith2000BuyoneGet1000Discount()
        {
            _cart.Add(new OrderItem() { Quantity = 2000, Sku = "BF" });
            Assert.AreEqual(1000, _cart.TotalAmount());
        }
        [TestMethod]
